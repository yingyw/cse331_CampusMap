...
public class MarvelPaths {	
	...
	public static void main(String[] args) throws Exception {
		...
		if (!graph.containsNode(start) || !graph.containsNode(end)) {
			...
			List<String> paths = MarvelPaths.findPath(graph, start, end);
	...
	public static Graph<String, String> loadGraph(String filename){
		...
		return loadGraph(characters, books);
	}
	/**
	 ...
	 */
	private static Graph<String, String> loadGraph(Set<String> characters, Map<String, List<String>> books){
		Graph<String, String> graph = new Graph<String, String>();
