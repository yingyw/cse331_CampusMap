...
/**
 * This class, along with HW8TestDriver, can be used to test your Campus Paths
 * application. It is assumed that the files are located in the same directory.
 *
 ...
 * In this case, it will create one HW8TestDriver instance per .expected file,
